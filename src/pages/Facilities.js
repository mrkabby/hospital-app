  ...
  return (
    <div className="bg-teal-50 dark:bg-zinc-900 p-8">
      ...
      <div className="flex justify-center mt-8">
        <button className="inline-flex items-center px-6 py-3 border border-[#19B0A1] text-teal-500 font-semibold rounded-md hover:bg-[#274D7C] hover:text-white transition" onClick={() => navigate("/allfacilities")}>
          View All
